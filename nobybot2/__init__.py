...
if ENV:
    ...
    from nobybot2.config import Development as Config
    TOKEN = os.getenv('TOKEN')
    API_ID = os.getenv('API_ID')
    API_HASH = os.getenv('API_HASH')
    DB_URI = os.getenv('DATABASE_URL')
...
from nobybot2.config import ARQ_API_KEY, ARQ_API_URL


aiohttpsession = ClientSession()
arq = ARQ(ARQ_API_URL, ARQ_API_KEY, aiohttpsession)
updater = tg.Updater(TOKEN, workers=WORKERS, use_context=True)
pgram = Client("nobybot2", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from nobybot2.modules.helper_funcs.handlers import (CustomCommandHandler,
