...
import nobybot2.modules.sql.connection_sql as sql
from nobybot2 import dispatcher, DRAGONS, DEV_USERS
from nobybot2.modules.helper_funcs import chat_status
...
This allows you to connect to a chat's database, and add things to it without the commands appearing in chat! For obvious reasons, you need to be an admin to add things; but any member in the group can view your data.
 ...
 ✪︎ /connect: Connects to chat (Can be done in a group by /connect or /connect <chat id> in PM)
 ✪︎ /connection: List connected chats
 ✪︎ /disconnect: Disconnect from a chat
 ✪︎ /helpconnect: List available commands that can be used remotely
