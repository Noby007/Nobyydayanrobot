...
from nobybot2 import dispatcher
from nobybot2.modules.helper_funcs.handlers import (CMD_STARTERS,
                                                        SpamChecker)
from nobybot2.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from nobybot2.modules.helper_funcs.chat_status import (
        connection_status, is_user_admin, user_admin)
    from nobybot2.modules.sql import disable_sql as sql
    ...
    __help__ = """
    ✪︎ `/cmds`*:* check the current status of disabled commands

    *Admins only:*
    ✪︎ `/enable <cmd name>`*:* enable that command
    ✪︎ `/disable <cmd name>`*:* disable that command
    ✪︎ `/enablemodule <module name>`*:* enable all commands in that module
    ✪︎ `/disablemodule <module name>`*:* disable all commands in that module
    ✪︎ `/listcmds`*:* list all possible toggleable commands
    """
