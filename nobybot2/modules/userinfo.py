...
from nobybot2 import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
                          INFOPIC, dispatcher,StartTime,SUPPORT_CHAT,sw,UPDATES_CHANNEL)
from nobybot2.__main__ import STATS, TOKEN, USER_INFO
import nobybot2.modules.sql.userinfo_sql as sql
from nobybot2.modules.disable import DisableAbleCommandHandler
from nobybot2.modules.sql.global_bans_sql import is_user_gbanned
from nobybot2.modules.sql.afk_sql import is_afk, check_afk_status
from nobybot2.modules.sql.users_sql import get_user_num_chats
from nobybot2.modules.helper_funcs.chat_status import sudo_plus
from nobybot2.modules.helper_funcs.extraction import extract_user
from nobybot2 import telethn as tbot , TIGERS, DRAGONS, DEMONS
...
def stats(update: Update, context: CallbackContext):
    ...
    test = "📊 Bot Stats:\n\n"
    test += f"<b>Python Version</b>: {ptbver}\n"
    test += f"<b>Pyrogram Versio</b>: {pyrogram_version}\n"
    test += f"<b>Telethon Version</b>: {telethon_version}\n\n"
    stats = f"<b>📊 Current Chat stats:</b>\n" + "\n" + output + "\n".join(
        [mod.__stats__() for mod in STATS])
    result = re.sub(r'(\d+)', r'<code>\1</code>', stats)
    update.effective_message.reply_animation(SATS_IMG,caption=(test+result),
